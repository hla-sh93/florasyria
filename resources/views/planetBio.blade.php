...
@section('title') BioDiversity @endsection
    @section('content')
        ...
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
              <h1 class="mb-2 bread">Plant BioDiversity</h1>
    ...
    <section class="ftco-section">
        <div class="container">
            <div class="row justify-content-center mb-2">
                ...
                <h2 class="mb-4 text-center heading-section">{{__('Vegetation zones')}}</h2>
				</div>
			</div>
 <br> <br>
            <div class="row">
